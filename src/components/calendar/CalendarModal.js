...
const horasMas = now.clone().add(2,'hours');
...
export const CalendarModal =()=>{
    ...
    const [ dateEnd,setDateEnd ] = useState(horasMas.toDate());
    ...
    return(
        ...
        >
            ...
            <hr />
            <form className="container" onSubmit={ handSubmitForm }>
